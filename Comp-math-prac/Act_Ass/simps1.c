...
void main()
{
    printf("Integrating 1/(1+x) using Simpson's 1/3rd rule \n");
    float u, l;
    ...
    printf("The result of integrating 1/(1+x) from lower limit %f to upper limit %f using Simpsons 1/3rd rule is :\n%f", l, u, result);
}